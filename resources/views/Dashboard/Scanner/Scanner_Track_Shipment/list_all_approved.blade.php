            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <table id="table_id" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tr>
                            <th>#</th>
                            <th>{{trans('Dashboard\trans_scanner_track.shipment_name')}}</th>
                            <th>{{trans('Dashboard\trans_scanner_track.tracking_stage_id')}}</th>
                            <th>{{trans('Dashboard\trans_scanner_track.customer_id')}}</th>
                            <th>{{trans('Dashboard\trans_scanner_track.shipment_num')}}</th>
                            <th>{{trans('Dashboard\trans_scanner_track.Processes')}}</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php $i = 0;?>
                            ...
                            @foreach($shipments as $shipment)
                                ...
                                <td>
                                    <button type="button" class="btn btn-warning" data-toggle="modal"
                                            ...
                                            title=" {{trans('Dashboard\trans_scanner_track.Add')}}">{{trans('Dashboard\trans_scanner_track.Add')}}</i>
                                    </button>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">{{trans('Dashboard\trans_scanner_track.Add_to_schedual')}}</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    </button>
                                                </div>
                                                <div class="modal-body">

                                                    <form role="form" action="{{route('scanner_tracks.store')}}" method="post">
                                                        @csrf
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                                <div class="form-group">
                                                                    <label for="exampleFormControlSelect2">{{trans('Dashboard\trans_scanner_track.customer_id')}}</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-4 col-sm-4 col-md-4">
                                                                <div class="form-group">
                                                                    <label for="full_number">{{trans('Dashboard\trans_scanner_track.full_number')}}</label>
                                                            ...
                                                            <div class="col-xs-4 col-sm-4 col-md-4">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="price">{{trans('Dashboard\trans_scanner_track.location_now')}}</label>
                                                            ...
                                                            <div class="col-xs-4 col-sm-4 col-md-4">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="currency_id">{{trans('Dashboard\trans_scanner_track.outcomming_date')}}</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                                <div class="form-group">
                                                                    <label for="currency_id">{{trans('Dashboard\trans_scanner_track.notes')}}</label>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success">{{trans('Dashboard\trans_scanner_track.submit')}}</button>

                                                            <button type="button" class="btn btn-default" data-dismiss="modal">{{trans('Dashboard\trans_scanner_track.close')}}</button>
                                                        </div>
                                    ...
                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete{{$shipment->id}}"
                                            title=" {{trans('Dashboard\trans_ship.Delete')}}">{{trans('Dashboard\trans_scanner_track.delete')}}
                                    </button>
                                    <div class="modal fade" id="delete{{$shipment->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">{{trans('Dashboard\trans_scanner_track.refuse_shipment')}}</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">×</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form role="form" action="{{route('scanner_tracks.destroy','$shipment->id')}}" method="post">
                                                        {{method_field('Delete')}}
                                                        @csrf
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success">{{trans('Dashboard\trans_scanner_track.delete')}}</button>
