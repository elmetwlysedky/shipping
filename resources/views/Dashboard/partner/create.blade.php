                        ...
                        <!-- Form -->
                            ...
                            <!-- Form Row -->
                                <div class="form-row mb-20">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="theme-input-style" placeholder="{{ucwords(trans('Dashboard/trans_partner.Name En'))}}" name="en_name" value="{{old('en_name')}}">
                                        @error('en_name')
                                ...
                                <div class="form-row mb-20">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="theme-input-style" placeholder="{{ucwords(trans('Dashboard/trans_partner.Name Ar'))}}" name="ar_name" value="{{old('ar_name')}}">
                                        @error('ar_name')
                                        <div class="alert alert-danger my-2" role="alert">{{$message}}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row mb-20">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="url" class="theme-input-style" placeholder="{{ucwords(trans('Dashboard/trans_partner.link'))}}" name="link" value="{{old('link')}}">
                                        @error('link')
                                        <div class="alert alert-danger my-2" role="alert">{{$message}}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col-12 text-right">
                                        <button type="submit" class="btn long">{{ucwords(trans('Dashboard/trans_partner.create'))}}</button>
                                    </div>
                                </div>
                                <!-- End Form Row -->
                            </form>
